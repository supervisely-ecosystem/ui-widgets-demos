...
from supervisely.app.widgets import Card, Container, Grid, LinePlot, Button
...
grid_plot = Grid(widgets=[line_plot_1, line_plot_2, line_plot_3, line_plot_4, line_plot_5], columns=3)
