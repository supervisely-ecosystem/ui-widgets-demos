...
![cascader_default](https://user-images.githubusercontent.com/120389559/226871849-1cb5f79a-6a80-438f-b95e-6983a8a5feba.gif)
...
|  `selected_items`   |                `List[str]`                |                     Current selected option                      |
...
| `parent_selectable` |                  `bool`                   |      Whether selecting an option of any level is permitted       |
...
```python
select_items = Cascader(items=animals, parent_selectable=True)
```
...
| :-------------------------------------: | --------------------------------------------------- |
|         `get_selected_items()`          | Return `Cascader` selected value.                   |
|     `select_item(value: List[str])`     | Set `Cascader` selected value.                      |
|              `deselect()`               | Clear `Cascader` selected value.                    |
|              `get_items()`              | Return `Cascader` items.                            |
| `set_items(value: List[Cascader.Item])` | Set `Cascader` items.                               |
|              `add_item()`               | Add item in `Cascader`.                             |
