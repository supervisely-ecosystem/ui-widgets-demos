...
| :-----------------: | :--------------------------------------------------------------------------------------------: | :-----------------------------------------------------------------------: |
|       `total`       |                                             `int`                                              |                      Total `Pagination` items count                       |
|     `page_size`     |                                             `int`                                              |                          Item count of each page                          |
|   `current_page`    |                                             `int`                                              |                            Current page number                            |
|      `layout`       | `Union[str, List[Literal["sizes", "prev", "pager", "next", "jumper", "->", "total", "slot"]]]` | Layout of `Pagination`, list of elements or string separated with a comma |
|      `compact`      |                                             `bool`                                             |                      Whether to use small pagination                      |
...
```python
pagination = Pagination(total=1000, page_size_options=[10, 20, 50], layout="prev, pager, next, sizes")
```
...
|                                          `set_current_page(value: int)`                                          | Set `Pagination` current page.                      |
|                                                  `get_total()`                                                   | Return `Pagination` total items count.              |
|                                             `set_total(value: int)`                                              | Set `Pagination` total items count.                 |
|                                                `get_page_size()`                                                 | Get `Pagination` page size (items count per page).  |
|                                           `set_page_size(value: int)`                                            | Set `Pagination` page size (items count per page).  |
|                                            `get_page_size_options()`                                             | Return `Pagination` page sizes data.                |
|                                       `set_page_size_options(value: int)`                                        | Set `Pagination` page sizes data.                   |
| `set_layout(value: Union[str, List[Literal["sizes", "prev", "pager", "next", "jumper", "->", "total", "slot"]]]` | Set `Pagination` layout.                            |
|                                                 `@page_changed`                                                  | Decorator function to handle `current-page` change. |
|                                               `@page_size_changed`                                               | Decorator function to handle `page-size` change.    |
...
### Initialize `Pagination`, `Button` and `Text` widgets
