...
[Read this tutorial in developer portal.](https://developer.supervisely.com/app-development/widgets/controls/hotkeys)
...
[supervisely-ecosystem/ui-widgets-demos/controls/011_hotkeys/src/main.py](https://github.com/supervisely-ecosystem/ui-widgets-demos/blob/master/controls/011_hotkeys/src/main.py)
...
Prepare a layout using the `Card` widget with the `content` parameter. The `Hotkeys` widget has no visual representation, but it still has to be placed somewhere in the widget tree (e.g. inside the `Container`) for its listener to be mounted.
